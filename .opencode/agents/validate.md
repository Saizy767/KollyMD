---
description: Validates the project by running typecheck, build, and architectural lint rules. Use after making code changes to verify the project compiles, builds, and obeys architecture rules. Reports pass/fail with specific errors. Read-only — does not edit code.
mode: subagent
permission:
  edit: deny
  bash:
...
6. If all pass, report: "Validation passed: typecheck OK, build OK, arch lint OK."
7. If any fail, report the specific errors (file paths, line numbers, error
